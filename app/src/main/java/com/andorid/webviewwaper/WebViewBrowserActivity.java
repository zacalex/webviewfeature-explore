...
package com.andorid.webviewwaper;
...
public class WebViewBrowserActivity extends Activity implements PopupMenu.OnMenuItemClickListener {
    private static final String TAG = "Car Compat";
...
//            mOnUxRestrictionsChangedListener = restrictionInfo -> {
//                if (restrictionInfo.isRequiresDistractionOptimization()) {
//                    // redirectForDistractionOptimization();
//                    mWebView.loadUrl("https://www.google.com/");
//                } else {
//                    setUrlBarText(mSelectedUrl);
...
//        CarUxRestrictionsUtil.getInstance(getApplicationContext()).register(mOnUxRestrictionsChangedListener);
    ...
    public void onDestroy() {
        super.onDestroy();
//        CarUxRestrictionsUtil.getInstance(getApplicationContext()).unregister(mOnUxRestrictionsChangedListener);
    }
    ...
    private void createAndInitializeWebView() {
        ...
        setTitle(getResources().getString(R.string.app_name) + " " + mWebViewVersion);
    ...
    public void backToSelection(View view){
        Intent intent = new Intent(this, WebSelectActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch(item.getItemId()) {
            ...
            case R.id.menu_about:
                ...
                return true;
            default:
                mBack.setClickable(mWebView.canGoBack());
                mForward.setClickable(mWebView.canGoForward());
                return false;
        }
    }

    private void initializeSettings(WebSettings settings) {
        String newUA= "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36";
    ...
    private void redirectForDistractionOptimization() {
